...
namespace trsaints_frontend_api.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeployUrl = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    Banner = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Projects_TechStacks_StackId",
                        column: x => x.StackId,
