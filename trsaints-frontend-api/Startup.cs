...
public static class Startup
{
    public static void SetAllowedHosts(WebApplicationBuilder builder)
    {
        builder.Configuration["AllowedHosts"] =
            builder.Configuration.GetValue<string>(
                AllowedDomainConstants.DomainHostNames);
    }
    ...
    public static void AddSwagger(WebApplicationBuilder builder)
    {
        builder.Services.AddSwaggerGen(c =>
        {
            c.SwaggerDoc("v1",
                         new OpenApiInfo
                         {
                             Title = "Trsaints API", Version = "v0.4.0"
                         });
    ...
    public static void AddScopes(WebApplicationBuilder builder)
    {
        ...
        builder.Services
               .AddScoped<IRelatedProjectsRepository,
                   ProjectRepository>();
                       ...
                       new TokenValidationParameters
                       {
                           ...
                           IssuerSigningKey =
                               new SymmetricSecurityKey(
                                   Encoding.UTF8.GetBytes(jwtAuthKey))
                       };
               })
    ...
    public static async Task EnsureCreatedRoles(
